...
document.addEventListener('scroll',()=>{var scroll_position = window.scrollY;if(scroll_position > 250){header.style.backgroundColor = '#00baff';}else{header.style.backgroundColor='transparent';}});
